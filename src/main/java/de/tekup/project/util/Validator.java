...
public class Validator {
	...
	public static boolean isProductEmpty(Evenements ev) {

		if (ev.getNom() == null || ev.getNom() == "") {
			return true;
		}
		if (ev.getAdresse() == null || ev.getAdresse() == "") {
			return true;
		}
		if (ev.getType() == null || ev.getType() == "") {
			return true;
		}
		if (ev.getDate() == null ) {
			return true;
